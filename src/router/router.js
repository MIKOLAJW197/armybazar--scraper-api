...
const addOffer = require("../utils/addOffer");
...
router.get("/getShortOffers/:pageNumber", (req, res) =>
  offerListScraper(
    "http://bron-i-amunicja.armybazar.eu/pl/bron-krotka/strona/",
...
router.get("/getLongOffers/:pageNumber", (req, res) =>
  offerListScraper(
    "http://bron-i-amunicja.armybazar.eu/pl/bron-dluga/strona/",
    req.params.pageNumber
  ).then((resp) => res.send(resp))
);
...
router.get("/getAmmunitionOffers/:pageNumber", (req, res) =>
  offerListScraper(
    "http://bron-i-amunicja.armybazar.eu/pl/amunicja/strona/",
    req.params.pageNumber
  ).then((resp) => res.send(resp))
);
...
router.get("/getAccesoriesOffers/:pageNumber", (req, res) =>
  offerListScraper(
    "http://bron-i-amunicja.armybazar.eu/pl/akcesoria/strona/",
    req.params.pageNumber
  ).then((resp) => res.send(resp))
);
...
router.post("/getOfferDetails", (req, res) =>
  offerDetailsScraper(req.body.offerUrl).then((resp) => res.send(resp))
);

// define add offer endPoint
